...
public class WaterlilyBlock extends VegetationBlock {
   ...
   protected WaterlilyBlock(final BlockBehaviour.Properties properties) {
      super(properties);
   }
   ...
   protected boolean mayPlaceOn(final BlockState state, final BlockGetter level, final BlockPos pos) {
      ...
      return (fluidState.getType() == Fluids.WATER || state.getBlock() instanceof IceBlock) && fluidAbove.getType() == Fluids.EMPTY;
   }
}
