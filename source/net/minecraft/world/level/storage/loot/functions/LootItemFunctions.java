...
public class LootItemFunctions {
   ...
   private static <T extends LootItemFunction> LootItemFunctionType<T> register(final String name, final MapCodec<T> codec) {
      return Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, Identifier.withDefaultNamespace(name), new LootItemFunctionType<>(codec));
   }
