...
public class NumberProviders {
   ...
   private static LootNumberProviderType register(final String name, final MapCodec<? extends NumberProvider> codec) {
      return Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, Identifier.withDefaultNamespace(name), new LootNumberProviderType(codec));
   }
}
