...
public class StructureFeatureIndexSavedData extends SavedData {
   ...
   public static final Codec<StructureFeatureIndexSavedData> CODEC = RecordCodecBuilder.create(
      i -> i.group(LONG_SET.fieldOf("All").forGetter(data -> data.all), LONG_SET.fieldOf("Remaining").forGetter(data -> data.remaining))
         .apply(i, StructureFeatureIndexSavedData::new)
   );
