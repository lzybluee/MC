...
public class GeodeConfiguration implements FeatureConfiguration {
   ...
   public GeodeConfiguration(
      final GeodeBlockSettings geodeBlockSettings,
      final GeodeLayerSettings geodeLayerSettings,
      final GeodeCrackSettings geodeCrackSettings,
      final double usePotentialPlacementsChance,
      final double useAlternateLayer0Chance,
      final boolean placementsRequireLayer0Alternate,
      final IntProvider outerWallDistance,
      final IntProvider distributionPoints,
      final IntProvider pointOffset,
      final int minGenOffset,
      final int maxGenOffset,
      final double noiseMultiplier,
      final int invalidBlocksThreshold
   ) {
