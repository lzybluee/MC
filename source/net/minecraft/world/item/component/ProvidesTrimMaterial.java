...
public record ProvidesTrimMaterial(EitherHolder<TrimMaterial> material) {
   ...
   public ProvidesTrimMaterial(final Holder<TrimMaterial> material) {
      this(new EitherHolder<>(material));
   }

   @Deprecated
   public ProvidesTrimMaterial(final ResourceKey<TrimMaterial> material) {
      this(new EitherHolder<>(material));
   }

   public Optional<Holder<TrimMaterial>> unwrap(final HolderLookup.Provider registries) {
