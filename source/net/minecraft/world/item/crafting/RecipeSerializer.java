...
public interface RecipeSerializer<T extends Recipe<?>> {
   ...
   static <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(final String name, final S serializer) {
      return Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, name, serializer);
   }
}
