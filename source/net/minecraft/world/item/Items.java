...
public class Items {
   ...
   public static final Item BROWN_CARPET = registerBlock(Blocks.BROWN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN)));
   public static final Item GREEN_CARPET = registerBlock(Blocks.GREEN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN)));
