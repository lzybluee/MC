   ...
   private static class SlimeAttackGoal extends Goal {
      ...
      public boolean canUse() {
         ...
         if (target == null) {
            ...
            return !this.slime.canAttack(target) ? false : this.slime.getMoveControl() instanceof Slime.SlimeMoveControl;
         }
      }
      ...
      public boolean canContinueToUse() {
         ...
         if (target == null) {
            ...
            return !this.slime.canAttack(target) ? false : --this.growTiredTimer > 0;
         }
      }
