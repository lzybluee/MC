...
public class HappyGhastAi {
   ...
   protected static Brain<?> makeBrain(final Brain<HappyGhast> brain) {
   ...
   private static void initCoreActivity(final Brain<HappyGhast> brain) {
      brain.addActivity(
         Activity.CORE,
         0,
         ImmutableList.of(
   ...
   private static void initIdleActivity(final Brain<HappyGhast> brain) {
      brain.addActivity(
         Activity.IDLE,
         ImmutableList.of(
   ...
   private static void initPanicActivity(final Brain<HappyGhast> brain) {
