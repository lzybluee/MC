...
public class TreeFeatures {
   ...
   private static TreeConfiguration.TreeConfigurationBuilder createStraightBlobTree(
      final Block oakLog, final Block oakLeaves, final int baseHeight, final int heightRandA, final int heightRandB, final int blobRadius
   ) {
   ...
   public static void bootstrap(final BootstrapContext<ConfiguredFeature<?, ?>> context) {
      ...
      FeatureUtils.register(
         context, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build()
      );
