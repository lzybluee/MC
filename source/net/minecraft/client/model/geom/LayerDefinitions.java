...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      result.put(ModelLayers.AXOLOTL_BABY, axolotlBodyLayer.apply(AxolotlModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.CAT, felineBodyLayer.apply(CatModel.CAT_TRANSFORMER));
      result.put(ModelLayers.CAT_BABY, felineBabyBodyLayer.apply(CatModel.CAT_TRANSFORMER));
      result.put(ModelLayers.CAT_COLLAR, felineCollarLayer.apply(CatModel.CAT_TRANSFORMER));
      result.put(ModelLayers.CAT_BABY_COLLAR, felineCollarLayer.apply(FelineModel.BABY_TRANSFORMER).apply(CatModel.CAT_TRANSFORMER));
      ...
      result.put(ModelLayers.CHICKEN_BABY, chickenBodyLayer.apply(ChickenModel.BABY_TRANSFORMER));
      result.put(ModelLayers.COD, CodModel.createBodyLayer());
      result.put(ModelLayers.COLD_CHICKEN, coldChickenBodyLayer);
      result.put(ModelLayers.COLD_CHICKEN_BABY, coldChickenBodyLayer.apply(ChickenModel.BABY_TRANSFORMER));
      result.put(ModelLayers.COLD_COW, coldCowBodyLayer);
      result.put(ModelLayers.COLD_COW_BABY, coldCowBodyLayer.apply(CowModel.BABY_TRANSFORMER));
      result.put(ModelLayers.COLD_PIG, coldPigBodyLayer);
      result.put(ModelLayers.COLD_PIG_BABY, coldPigBodyLayer.apply(PigModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.COW_BABY, cowBodyLayer.apply(CowModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.DOLPHIN_BABY, dolphinBodyLayer.apply(DolphinModel.BABY_TRANSFORMER));
      result.put(ModelLayers.DONKEY, DonkeyModel.createBodyLayer(0.87F));
      result.put(ModelLayers.DONKEY_BABY, DonkeyModel.createBabyLayer(0.87F));
      result.put(ModelLayers.DONKEY_SADDLE, DonkeyModel.createSaddleLayer(0.87F, false));
      result.put(ModelLayers.DONKEY_BABY_SADDLE, DonkeyModel.createSaddleLayer(0.87F, true));
      ...
      result.put(ModelLayers.GLOW_SQUID_BABY, squidBodyLayer.apply(SquidModel.BABY_TRANSFORMER));
      ...
      result.put(
         ModelLayers.HORSE_BABY_ARMOR, LayerDefinition.create(AbstractEquineModel.createBabyMesh(new CubeDeformation(0.1F)), 64, 64).apply(livingHorseScale)
      );
      result.put(ModelLayers.HORSE_SADDLE, horseSaddleLayer.apply(livingHorseScale));
      result.put(ModelLayers.HORSE_BABY_SADDLE, horseBabySaddleLayer.apply(livingHorseScale));
      ...
      result.put(ModelLayers.MOOSHROOM_BABY, cowBodyLayer.apply(CowModel.BABY_TRANSFORMER));
      result.put(ModelLayers.MULE, DonkeyModel.createBodyLayer(0.92F));
      result.put(ModelLayers.MULE_BABY, DonkeyModel.createBabyLayer(0.92F));
      result.put(ModelLayers.MULE_SADDLE, DonkeyModel.createSaddleLayer(0.92F, false));
      result.put(ModelLayers.MULE_BABY_SADDLE, DonkeyModel.createSaddleLayer(0.92F, true));
      ...
      result.put(ModelLayers.PIG_BABY, pigBodyLayer.apply(PigModel.BABY_TRANSFORMER));
      result.put(ModelLayers.PIG_SADDLE, pigSaddleLayer);
      result.put(ModelLayers.PIG_BABY_SADDLE, pigSaddleLayer.apply(PigModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.RABBIT, RabbitModel.createBodyLayer(false));
      result.put(ModelLayers.RABBIT_BABY, RabbitModel.createBodyLayer(true));
      ...
      result.put(ModelLayers.SHEEP_BABY, sheepBodyLayer.apply(SheepModel.BABY_TRANSFORMER));
      result.put(ModelLayers.SHEEP_WOOL, sheepWoolLayer);
      result.put(ModelLayers.SHEEP_BABY_WOOL, sheepWoolLayer.apply(SheepModel.BABY_TRANSFORMER));
      result.put(ModelLayers.SHEEP_WOOL_UNDERCOAT, sheepBodyLayer);
      result.put(ModelLayers.SHEEP_BABY_WOOL_UNDERCOAT, sheepBodyLayer.apply(SheepModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.SKELETON_HORSE_BABY_SADDLE, horseBabySaddleLayer);
      ...
      result.put(ModelLayers.SQUID_BABY, squidBodyLayer.apply(SquidModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.TURTLE_BABY, turtleBodyLayer.apply(TurtleModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.UNDEAD_HORSE_BABY_ARMOR, LayerDefinition.create(AbstractEquineModel.createBabyMesh(new CubeDeformation(0.1F)), 64, 64));
      ...
      result.put(ModelLayers.WARM_COW_BABY, warmCowBodyLayer.apply(CowModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.WOLF_BABY, wolfBodyLayer.apply(WolfModel.BABY_TRANSFORMER));
      result.put(ModelLayers.WOLF_BABY_ARMOR, wolfArmorLayer.apply(WolfModel.BABY_TRANSFORMER));
      ...
      result.put(ModelLayers.ZOMBIE_HORSE_BABY_SADDLE, horseBabySaddleLayer);
