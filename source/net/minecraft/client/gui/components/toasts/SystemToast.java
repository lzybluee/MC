...
public class SystemToast implements Toast {
   ...
   public static SystemToast multiline(final Minecraft minecraft, final SystemToast.SystemToastId id, final Component title, final Component message) {
   ...
   private SystemToast(final SystemToast.SystemToastId id, final Component title, final List<FormattedCharSequence> messageLines, final int width) {
      this.id = id;
      this.title = title;
   ...
   public static void addOrUpdate(final ToastManager toastManager, final SystemToast.SystemToastId id, final Component title, final @Nullable Component message) {
