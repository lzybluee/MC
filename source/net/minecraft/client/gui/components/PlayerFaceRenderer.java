...
public class PlayerFaceRenderer {
   ...
   public static void draw(
      final GuiGraphics graphics, final Identifier texture, final int x, final int y, final int size, final boolean hat, final boolean flip, final int color
   ) {
   ...
   private static void drawHat(
      final GuiGraphics graphics, final Identifier texture, final int x, final int y, final int size, final boolean flip, final int color
   ) {
