...
public record BlockElementFace(@Nullable Direction cullForDirection, int tintIndex, String texture, BlockElementFace.@Nullable UVs uvs, Quadrant rotation) {
   ...
   public static float getU(final BlockElementFace.UVs uvs, final Quadrant rotation, final int vertex) {
      return uvs.getVertexU(rotation.rotateVertexIndex(vertex)) / 16.0F;
   }

   public static float getV(final BlockElementFace.UVs uvs, final Quadrant rotation, final int index) {
   ...
   protected static class Deserializer implements JsonDeserializer<BlockElementFace> {
      ...
      public BlockElementFace deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context) throws JsonParseException {
         ...
         BlockElementFace.UVs uvs = getUVs(object);
      ...
      private static BlockElementFace.@Nullable UVs getUVs(final JsonObject object) {
         if (!object.has("uv")) {
            return null;
         }
