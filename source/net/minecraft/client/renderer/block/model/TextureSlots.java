...
public class TextureSlots {
   ...
   public static TextureSlots.Data parseTextureMap(final JsonObject texturesObject) {
      ...
      for (Entry<String, JsonElement> entry : texturesObject.entrySet()) {
         parseEntry(entry.getKey(), entry.getValue().getAsString(), builder);
      }

      return builder.build();
   }

   private static void parseEntry(final String slot, final String value, final TextureSlots.Data.Builder output) {
