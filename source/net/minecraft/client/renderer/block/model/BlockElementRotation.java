...
public record BlockElementRotation(Vector3fc origin, BlockElementRotation.RotationValue value, boolean rescale, Matrix4fc transform) {
   public BlockElementRotation(final Vector3fc origin, final BlockElementRotation.RotationValue value, final boolean rescale) {
      this(origin, value, rescale, computeTransform(value, rescale));
   }

   private static Matrix4f computeTransform(final BlockElementRotation.RotationValue value, final boolean rescale) {
