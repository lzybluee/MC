...
public class ItemBlockRenderTypes {
   private static final Map<Block, ChunkSectionLayer> TYPE_BY_BLOCK = Util.make(Maps.newHashMap(), map -> {
      ChunkSectionLayer tripwire = ChunkSectionLayer.TRIPWIRE;
      map.put(Blocks.TRIPWIRE, tripwire);
   ...
   private static final Map<Fluid, ChunkSectionLayer> LAYER_BY_FLUID = Util.make(Maps.newHashMap(), map -> {
   ...
   public static ChunkSectionLayer getChunkRenderType(final BlockState state) {
      ...
      ChunkSectionLayer layer = TYPE_BY_BLOCK.get(block);
   ...
   public static ChunkSectionLayer getRenderLayer(final FluidState state) {
      ChunkSectionLayer layer = LAYER_BY_FLUID.get(state.getType());
      return layer != null ? layer : ChunkSectionLayer.SOLID;
   }
