...
public class MissingBlockModel {
   ...
   public static UnbakedModel missingModel() {
      ...
      Map<Direction, BlockElementFace> faces = Util.makeEnumMap(
         Direction.class, direction -> new BlockElementFace(direction, -1, "missingno", fullFaceUv, Quadrant.R0)
      );
      BlockElement cube = new BlockElement(new Vector3f(0.0F, 0.0F, 0.0F), new Vector3f(16.0F, 16.0F, 16.0F), faces);
      return new BlockModel(
         new SimpleUnbakedGeometry(List.of(cube)),
         null,
         null,
