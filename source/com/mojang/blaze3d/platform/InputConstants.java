...
public class InputConstants {
   ...
   public static void setupMouseCallbacks(
      final Window window,
      final GLFWCursorPosCallbackI onMoveCallback,
      final GLFWMouseButtonCallbackI onPressCallback,
      final GLFWScrollCallbackI onScrollCallback,
      final GLFWDropCallbackI onDropCallback
   ) {
